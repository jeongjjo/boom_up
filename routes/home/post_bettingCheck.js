...
module.exports = [
    '/bettingCheck', // URI : /test2 (최종은 /<route module>/<page module> : /sameple/test2)
    ...
    async function (req, res, next) {
        ...
        var resultCheck = await power.bettingCheck(userId, contentId)

        //관리자가 댓글 작성자 인끼업 운영자중 선택한 경우
        return res.json({
            result: resultCheck ? "ok" : "error",
            codemsg: "betting-check-post",
            dispaymsg: "",
            data: resultCheck
        });
    }
