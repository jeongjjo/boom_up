...
module.exports = [
    '/keyword/:text?', // URI : /test2 (최종은 /<route module>/<page module> : /sameple/test2)
    [], // 권한 : null은 권한 미체크, [] array 형as태로 권한 지정
    [
        // Validation 처리 ------------------------------------
        exValidator.param('text', 'REQ').not().isEmpty().trim(),
    ...
    async function (req, res, next) {
        ...
        var result = await db.getAndDelete("myKeyword", where);
