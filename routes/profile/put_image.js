...
module.exports = [
    '/image/:id', // URI : /test2 (최종은 /<route module>/<page module> : /sameple/test2)
    ...
    async function (req, res, next) {
        ...
        imagearray.push(req.body.thumbnail);
        var where = {
            $set: { photo : imagearray }
        }
        var a = await db.updateById("user", ObjectId(req.params.id), where);
