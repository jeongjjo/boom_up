...
module.exports = [
    '/popup/:id',  // URI : /test2 (최종은 /<route module>/<page module> : /sameple/test2)
    ...
    async function (req, res, next) {
        ...
        var isMine = !req.params.id || (req.user && req.params.id === req.user._id.toHexString());
