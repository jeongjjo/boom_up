...
module.exports = ['/oauth/addsignin/:snstype?', null, fileuploadEx.local.none()
    , [
        exValidator.param('snstype', 'REQ').trim(),
        exValidator.body('d', 'REQ').notEmpty().trim(),
        exValidator.body('ot', 'REQ').notEmpty().trim(),
...
async function signup(req, res) {
    switch (req.params.snstype) {
        ...
        case 'apple':
            {
                var result = await require(path.join('../../../module/oauth/', req.params.snstype)).addsignin(req.body.d, req.body.ot, req.body.i, req.body.t, req);
